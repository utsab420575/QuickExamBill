...
@section('content')
    <section role="main" class="content-body">
        ...
        @php
            ...
            /*For Paper Setter Examiner*/
            $savedRateAssignPaperSetter = RateAssign::getTeacherWithCourse($session_info->id, $exam_type->id, $rateHeadPaperSetter->id);
            $savedRateAssignExaminer = RateAssign::getTeacherWithCourse($session_info->id, $exam_type->id, $rateHeadExaminer->id);
