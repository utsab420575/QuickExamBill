            ...
            <section class="card card-featured card-featured-primary">
                ...
                <div class="card-body card-list-of-printing-question-paper">
                    ...
                    <div class="mt-3 text-end">
                        ...
                        <button type="button" id="remove-printing-question-paper-row" class="btn btn-sm btn-danger">- Remove Last</button>
                    </div>
        ...
        function createTeacherRow() {
            ...
            row.innerHTML = `
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <input type="number" name="printing_question_committee_amounts[]" step="any" class="form-control amount-input" placeholder="Provide Amount" disabled required>
                    </div>
                </div>
            `;
