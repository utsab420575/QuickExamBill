...
@push('scripts')
    <script>
        ...
        function createTeacherRow() {
            ...
            <div class="col-md-6">
                <select name="supervised_thesis_project_teacher_ids[]" data-plugin-selectTwo class="form-control teacher-select populate" data-row="${supervisedTheisProjectRowCount}" disabled required>
                    <option value="">-- Select Teacher --</option>
                    ${supervisedThesisProjectTeachers.map(t => `<option value="${t.id}">${t.user.name}, ${t.designation.designation},${t.department.shortname}</option>`).join('')}
                </select>
            </div>
            <div class="col-md-4">
