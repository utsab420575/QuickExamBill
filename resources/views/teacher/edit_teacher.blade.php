                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="edit" class="tab-pane">
                            <form method="POST" action="{{route('teacher.update')}}" class="p-3" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row row mb-4">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                               placeholder="Enter Name" value="{{ $teacher->user->name }}" required>
                                        @error('name')
                                ...
                                <div class="row mb-4">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone"
                                               placeholder="Enter your phone" value="{{ $teacher->user->phone  }}" required>
                                        @error('phone')
                                        <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="form-group col">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                               placeholder="Enter your email" value="{{ $teacher->user->email  }}" required>
                                        @error('email')
                                        <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="form-group col">
                                        ...
                                        <textarea class="form-control" rows="3" id="address" name="address">{{ $teacher->preaddress }}</textarea>
                                        @error('address')
                                        <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select class="form-control" name="designation" id="designation" required>
                                            ...
                                            @foreach($designations as $designation)
                                                <option value="{{$designation->id}}" {{ $teacher->designation_id == $designation->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <img id="showPhoto" src="{{ (!empty($teacher->user->photo)) ? url($teacher->user->photo) : url('upload/no_image.jpg') }}"
