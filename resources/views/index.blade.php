                            ...
                            <header class="card-header bg-primary w-100">
                                <div class="widget-profile-info">
                                    <div class="profile-picture">
                                        <img src="{{asset('backend/assets/img/!logged-user.jpg')}}">
                                    </div>
                                            ...
                                            <ul class="simple-user-list mb-3">
                                                <li>
                                                    <figure class="image rounded">
                                                        <img src="{{asset('backend/assets/img/!sample-user.jpg')}}" alt="Joseph Doe Junior" class="rounded-circle">
                                                    </figure>
                                                ...
                                                <li>
                                                    <figure class="image rounded">
                                                        <img src="{{asset('backend/assets/img/!sample-user.jpg')}}" alt="Joseph Junior" class="rounded-circle">
                                                    </figure>
                                                ...
                                                <li>
                                                    <figure class="image rounded">
                                                        <img src="{{asset('backend/assets/img/!sample-user.jpg')}}" alt="Joe Junior" class="rounded-circle">
                                                    </figure>
                                    ...
                                    <li>
                                        <div class="tm-box">
                                            ...
                                            <div class="thumbnail-gallery">
                                                <a class="img-thumbnail lightbox" href="{{asset('backend/assets/img/projects/project-4.jpg')}}" data-plugin-options='{ "type":"image" }'>
                                                    <img class="img-fluid" width="215" src="{{asset('backend/assets/img/projects/project-4.jpg')}}">
                                                    <span class="zoom">
